...
public class ShipStats extends EntityStats{
    ...
    public ShipStats(String id, String shipClass, String name, String description, String profileImagePath, String spritePath, int health, int damage, int state, String laserID, String civID) {
